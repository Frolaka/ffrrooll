...
export class OperationServiceBase {
  ...
  async Add(args: Operation): Promise<Operation> {
    throw new Error("Not implemented");
  }
  async Divide(args: Operation): Promise<Operation> {
    throw new Error("Not implemented");
  }
  async Multiply(args: Operation): Promise<Operation> {
    throw new Error("Not implemented");
  }
  async Subtract(args: Operation): Promise<Operation> {
    throw new Error("Not implemented");
  }
}
